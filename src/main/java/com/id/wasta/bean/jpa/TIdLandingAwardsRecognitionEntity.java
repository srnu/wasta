...
/**
 * Persistent class for entity stored in table "t_id_landing_awards_recognition"
 *
...
@Entity
@Table(name="t_id_landing_awards_recognition")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingAwardsRecognitionEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingAwardsRecognitionEntity x" )
} )
public class TIdLandingAwardsRecognitionEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingAwardsRecognitionEntity() {
		super();
    }
