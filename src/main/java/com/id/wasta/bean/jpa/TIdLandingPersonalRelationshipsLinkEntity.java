...
/**
 * Persistent class for entity stored in table "t_id_landing_personal_relationships_link"
 *
...
@Entity
@Table(name="t_id_landing_personal_relationships_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingPersonalRelationshipsLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingPersonalRelationshipsLinkEntity x" )
} )
public class TIdLandingPersonalRelationshipsLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingPersonalRelationshipsLinkEntity() {
		super();
    }
