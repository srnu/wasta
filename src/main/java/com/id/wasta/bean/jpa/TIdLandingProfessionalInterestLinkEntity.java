...
/**
 * Persistent class for entity stored in table "t_id_landing_professional_interest_link"
 *
...
@Entity
@Table(name="t_id_landing_professional_interest_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingProfessionalInterestLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingProfessionalInterestLinkEntity x" )
} )
public class TIdLandingProfessionalInterestLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingProfessionalInterestLinkEntity() {
		super();
    }
