...
/**
 * Persistent class for entity stored in table "t_id_landing_experience"
 *
...
@Entity
@Table(name="t_id_landing_experience")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingExperienceEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingExperienceEntity x" )
} )
public class TIdLandingExperienceEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingExperienceEntity() {
		super();
    }
