...
@NamedQueries ( {
  @NamedQuery ( name="TIdQualificationMasterEntity.countAll", query="SELECT COUNT(x) FROM TIdQualificationMasterEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdQualificationMasterEntity implements Serializable {
    ...
    @Unique(property = "name", tableName = "TIdQualificationMasterEntity", message="qualification.name.already.exists")
     private String     name         ;

    @Column(name="qualification_active_status_key", nullable=false)
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdQualificationMasterEntity() {
		super();
    }
