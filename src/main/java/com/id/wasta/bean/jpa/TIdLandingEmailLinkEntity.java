...
/**
 * Persistent class for entity stored in table "t_id_landing_email_link"
 *
...
@Entity
@Table(name="t_id_landing_email_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingEmailLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingEmailLinkEntity x" )
} )
public class TIdLandingEmailLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingEmailLinkEntity() {
		super();
    }
