...
@Entity
@Table(name="person_individual_experience_view")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="PersonIndividualExperienceViewEntity.countAll", query="SELECT COUNT(x) FROM PersonIndividualExperienceViewEntity x" )
} )
public class PersonIndividualExperienceViewEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public PersonIndividualExperienceViewEntity() {
		super();
    }
	...
	public String getPinCountryName() {
		return pinCountryName;
	}

	public void setPinCountryName(String pinCountryName) {
		this.pinCountryName = pinCountryName;
	}
