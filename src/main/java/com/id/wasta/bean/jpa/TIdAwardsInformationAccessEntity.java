...
/**
 * Persistent class for entity stored in table "t_id_awards_information_access"
 *
...
@Entity
@Table(name="t_id_awards_information_access")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdAwardsInformationAccessEntity.countAll", query="SELECT COUNT(x) FROM TIdAwardsInformationAccessEntity x" )
} )
public class TIdAwardsInformationAccessEntity implements Serializable {
    ...
    @Column(name="aia_pia_key", nullable=false)
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdAwardsInformationAccessEntity() {
		super();
    }
