...
@NamedQueries ( {
  @NamedQuery ( name="TIdDesignationMasterEntity.countAll", query="SELECT COUNT(x) FROM TIdDesignationMasterEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdDesignationMasterEntity implements Serializable {
    ...
    @Unique(property = "name", tableName = "TIdDesignationMasterEntity", message="designation.name.already.exists")
     private String     name         ;
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdDesignationMasterEntity() {
		super();
    }
