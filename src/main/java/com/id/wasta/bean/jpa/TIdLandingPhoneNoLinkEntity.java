...
/**
 * Persistent class for entity stored in table "t_id_landing_phone_no_link"
 *
...
@Entity
@Table(name="t_id_landing_phone_no_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingPhoneNoLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingPhoneNoLinkEntity x" )
} )
public class TIdLandingPhoneNoLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingPhoneNoLinkEntity() {
		super();
    }
