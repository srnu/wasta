...
/**
 * Persistent class for entity stored in table "t_id_landing_phone_no"
 *
...
@Entity
@Table(name="t_id_landing_phone_no")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingPhoneNoEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingPhoneNoEntity x" )
} )
public class TIdLandingPhoneNoEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingPhoneNoEntity() {
		super();
    }
