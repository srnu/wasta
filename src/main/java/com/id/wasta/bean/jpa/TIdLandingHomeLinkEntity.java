...
/**
 * Persistent class for entity stored in table "t_id_landing_home_link"
 *
...
@Entity
@Table(name="t_id_landing_home_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingHomeLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingHomeLinkEntity x" )
} )
public class TIdLandingHomeLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingHomeLinkEntity() {
		super();
    }
