...
/**
 * Persistent class for entity stored in table "t_id_landing_project_executed_link"
 *
...
@Entity
@Table(name="t_id_landing_project_executed_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingProjectExecutedLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingProjectExecutedLinkEntity x" )
} )
public class TIdLandingProjectExecutedLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingProjectExecutedLinkEntity() {
		super();
    }
