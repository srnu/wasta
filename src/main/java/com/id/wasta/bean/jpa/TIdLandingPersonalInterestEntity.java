...
/**
 * Persistent class for entity stored in table "t_id_landing_personal_interest"
 *
...
@Entity
@Table(name="t_id_landing_personal_interest")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingPersonalInterestEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingPersonalInterestEntity x" )
} )
public class TIdLandingPersonalInterestEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingPersonalInterestEntity() {
		super();
    }
