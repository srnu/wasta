/*
 * Created on 19 Apr 2019 ( Time 12:45:55 )
...
/**
 * Persistent class for entity stored in table "t_id_landing_business_potential_link"
 *
...
@Entity
@Table(name="t_id_landing_business_potential_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingBusinessPotentialLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingBusinessPotentialLinkEntity x" )
} )
public class TIdLandingBusinessPotentialLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingBusinessPotentialLinkEntity() {
		super();
    }
