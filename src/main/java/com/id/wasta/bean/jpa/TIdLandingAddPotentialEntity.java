...
/**
 * Persistent class for entity stored in table "t_id_landing_add_potential"
 *
...
@Entity
@Table(name="t_id_landing_add_potential")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingAddPotentialEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingAddPotentialEntity x" )
} )
public class TIdLandingAddPotentialEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingAddPotentialEntity() {
		super();
    }
