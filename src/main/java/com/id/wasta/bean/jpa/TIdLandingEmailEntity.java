...
/**
 * Persistent class for entity stored in table "t_id_landing_email"
 *
...
@Entity
@Table(name="t_id_landing_email")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingEmailEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingEmailEntity x" )
} )
public class TIdLandingEmailEntity implements Serializable {
    ...
    @Column(name="ld_read_flag", nullable=false)
