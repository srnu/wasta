...
/**
 * Persistent class for entity stored in table "t_id_landing_professional_relationship"
 *
...
@Entity
@Table(name="t_id_landing_professional_relationship")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingProfessionalRelationshipEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingProfessionalRelationshipEntity x" )
} )
public class TIdLandingProfessionalRelationshipEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingProfessionalRelationshipEntity() {
		super();
    }
