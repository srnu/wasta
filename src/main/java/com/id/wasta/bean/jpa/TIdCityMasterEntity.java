...
@NamedQueries ( {
  @NamedQuery ( name="TIdCityMasterEntity.countAll", query="SELECT COUNT(x) FROM TIdCityMasterEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdCityMasterEntity implements Serializable {
    ...
    @Unique(property = "name", tableName = "TIdCityMasterEntity", message="city.name.already.exists")
