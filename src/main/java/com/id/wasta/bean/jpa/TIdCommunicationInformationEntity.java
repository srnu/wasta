...
@NamedQueries ( {
  @NamedQuery ( name="TIdCommunicationInformationEntity.countAll", query="SELECT COUNT(x) FROM TIdCommunicationInformationEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdCommunicationInformationEntity implements Serializable {
   ...
   // @ManyToOne
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdCommunicationInformationEntity() {
		super();
    }
