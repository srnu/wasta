...
/**
 * Persistent class for entity stored in table "t_id_landing_discussion_dtls_link"
 *
...
@Entity
@Table(name="t_id_landing_discussion_dtls_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingDiscussionDtlsLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingDiscussionDtlsLinkEntity x" )
} )
public class TIdLandingDiscussionDtlsLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingDiscussionDtlsLinkEntity() {
		super();
    }
