...
/**
 * Persistent class for entity stored in table "t_id_landing_add_information"
 *
...
@Entity
@Table(name="t_id_landing_add_information")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingAddInformationEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingAddInformationEntity x" )
} )
public class TIdLandingAddInformationEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingAddInformationEntity() {
		super();
    }
