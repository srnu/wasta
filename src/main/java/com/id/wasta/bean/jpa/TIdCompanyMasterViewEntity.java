...
/*
 * Created on 21 Feb 2017 ( Time 16:33:23 )
...
/**
 * Persistent class for entity stored in table "t_id_company_master_view"
 *
...
@Entity
@Table(name="t_id_company_master_view" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdCompanyMasterViewEntity.countAll", query="SELECT COUNT(x) FROM TIdCompanyMasterViewEntity x" )
} )
public class TIdCompanyMasterViewEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdCompanyMasterViewEntity() {
		super();
    }
