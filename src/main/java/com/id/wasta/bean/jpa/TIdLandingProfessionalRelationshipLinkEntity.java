...
/**
 * Persistent class for entity stored in table "t_id_landing_professional_relationship_link"
 *
...
@Entity
@Table(name="t_id_landing_professional_relationship_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingProfessionalRelationshipLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingProfessionalRelationshipLinkEntity x" )
} )
public class TIdLandingProfessionalRelationshipLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingProfessionalRelationshipLinkEntity() {
		super();
    }
