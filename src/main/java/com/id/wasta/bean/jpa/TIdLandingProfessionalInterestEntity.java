...
/**
 * Persistent class for entity stored in table "t_id_landing_professional_interest"
 *
...
@Entity
@Table(name="t_id_landing_professional_interest")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingProfessionalInterestEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingProfessionalInterestEntity x" )
} )
public class TIdLandingProfessionalInterestEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingProfessionalInterestEntity() {
		super();
    }
