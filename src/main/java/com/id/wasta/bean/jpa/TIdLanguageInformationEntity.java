...
@NamedQueries ( {
  @NamedQuery ( name="TIdLanguageInformationEntity.countAll", query="SELECT COUNT(x) FROM TIdLanguageInformationEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdLanguageInformationEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLanguageInformationEntity() {
		super();
    }
