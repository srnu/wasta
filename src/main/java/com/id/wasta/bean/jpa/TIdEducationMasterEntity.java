/*
 * Created on 16 Nov 2016 ( Time 15:54:21 )
...
/**
 * Persistent class for entity stored in table "t_id_education_master"
 *
...
@Entity
@Table(name="t_id_education_master" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdEducationMasterEntity.countAll", query="SELECT COUNT(x) FROM TIdEducationMasterEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdEducationMasterEntity implements Serializable {
    ...
    @Column(name="edu_key", nullable=false)
    private Long       key          ;
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdEducationMasterEntity() {
		super();
    }
