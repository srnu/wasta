...
/**
 * Persistent class for entity stored in table "t_id_region_master"
 *
...
@Entity
@Table(name="t_id_region_master")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdRegionMasterEntity.countAll", query="SELECT COUNT(x) FROM TIdRegionMasterEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdRegionMasterEntity implements Serializable {
    ...
    @Unique(property = "name", tableName = "TIdRegionMasterEntity", message="region.name.already.exists")
     private String     name         ;
    ...
    @Column(name="region_status_key", nullable=false)
		
     private Long       regionStatusKey ;
    ...
    //--- DATABASE MAPPING : region_status_key ( BIGINT ) 
    public void setRegionStatusKey( Long regionStatusKey ) {
        this.regionStatusKey = regionStatusKey;
    }
    public Long getRegionStatusKey() {
        return this.regionStatusKey;
    }
