...
/**
 * Persistent class for entity stored in table "t_id_landing_awards_recognition_link"
 *
...
@Entity
@Table(name="t_id_landing_awards_recognition_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingAwardsRecognitionLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingAwardsRecognitionLinkEntity x" )
} )
public class TIdLandingAwardsRecognitionLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingAwardsRecognitionLinkEntity() {
		super();
    }
