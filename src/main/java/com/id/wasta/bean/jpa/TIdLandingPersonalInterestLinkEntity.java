/*
 * Created on 19 Apr 2019 ( Time 15:26:52 )
...
/**
 * Persistent class for entity stored in table "t_id_landing_personal_interest_link"
 *
...
@Entity
@Table(name="t_id_landing_personal_interest_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingPersonalInterestLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingPersonalInterestLinkEntity x" )
} )
public class TIdLandingPersonalInterestLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingPersonalInterestLinkEntity() {
		super();
    }
