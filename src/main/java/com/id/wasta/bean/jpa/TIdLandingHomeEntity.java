...
/**
 * Persistent class for entity stored in table "t_id_landing_home"
 *
...
@Entity
@Table(name="t_id_landing_home")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingHomeEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingHomeEntity x" )
} )
public class TIdLandingHomeEntity implements Serializable {
