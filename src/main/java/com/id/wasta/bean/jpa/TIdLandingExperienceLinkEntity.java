...
/**
 * Persistent class for entity stored in table "t_id_landing_experience_link"
 *
...
@Entity
@Table(name="t_id_landing_experience_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingExperienceLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingExperienceLinkEntity x" )
} )
public class TIdLandingExperienceLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingExperienceLinkEntity() {
		super();
    }
