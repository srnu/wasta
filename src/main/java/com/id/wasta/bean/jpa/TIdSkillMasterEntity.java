...
@NamedQueries ( {
  @NamedQuery ( name="TIdSkillMasterEntity.countAll", query="SELECT COUNT(x) FROM TIdSkillMasterEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdSkillMasterEntity implements Serializable {
