...
/**
 * Persistent class for entity stored in table "t_id_landing_personal_info"
 *
...
@Entity
@Table(name="t_id_landing_personal_info")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingPersonalInfoEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingPersonalInfoEntity x" )
} )
public class TIdLandingPersonalInfoEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingPersonalInfoEntity() {
		super();
    }
