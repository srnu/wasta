...
/**
 * Persistent class for entity stored in table "t_id_landing_professional_expertise"
 *
...
@Entity
@Table(name="t_id_landing_professional_expertise")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingProfessionalExpertiseEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingProfessionalExpertiseEntity x" )
} )
public class TIdLandingProfessionalExpertiseEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingProfessionalExpertiseEntity() {
		super();
    }
