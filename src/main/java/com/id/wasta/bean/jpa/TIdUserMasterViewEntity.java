/*
 * Created on 24 Nov 2016 ( Time 18:49:21 )
...
/**
 * Persistent class for entity stored in table "t_id_user_master_view"
 *
...
@Entity
@Table(name = "t_id_user_master_view")
// Define named queries here
@NamedQueries({ @NamedQuery(name = "TIdUserMasterViewEntity.countAll", query = "SELECT COUNT(x) FROM TIdUserMasterViewEntity x") })
public class TIdUserMasterViewEntity implements Serializable {
	...
	// CONSTRUCTOR(S)
	// ----------------------------------------------------------------------
	public TIdUserMasterViewEntity() {
		super();
	}
