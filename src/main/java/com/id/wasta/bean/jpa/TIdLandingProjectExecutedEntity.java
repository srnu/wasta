...
/**
 * Persistent class for entity stored in table "t_id_landing_project_executed"
 *
...
@Entity
@Table(name="t_id_landing_project_executed")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingProjectExecutedEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingProjectExecutedEntity x" )
} )
public class TIdLandingProjectExecutedEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingProjectExecutedEntity() {
		super();
    }
