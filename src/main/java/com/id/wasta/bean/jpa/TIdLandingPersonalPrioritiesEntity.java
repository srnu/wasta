...
/**
 * Persistent class for entity stored in table "t_id_landing_personal_priorities"
 *
...
@Entity
@Table(name="t_id_landing_personal_priorities")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingPersonalPrioritiesEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingPersonalPrioritiesEntity x" )
} )
public class TIdLandingPersonalPrioritiesEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingPersonalPrioritiesEntity() {
		super();
    }
