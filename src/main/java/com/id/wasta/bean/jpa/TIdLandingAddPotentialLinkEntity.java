...
/**
 * Persistent class for entity stored in table "t_id_landing_add_potential_link"
 *
...
@Entity
@Table(name="t_id_landing_add_potential_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingAddPotentialLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingAddPotentialLinkEntity x" )
} )
public class TIdLandingAddPotentialLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingAddPotentialLinkEntity() {
		super();
    }
