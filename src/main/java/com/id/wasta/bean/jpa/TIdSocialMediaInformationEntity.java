...
@NamedQueries ( {
  @NamedQuery ( name="TIdSocialMediaInformationEntity.countAll", query="SELECT COUNT(x) FROM TIdSocialMediaInformationEntity x" )
} )
@JsonInclude(JsonInclude.Include.NON_NULL)
public class TIdSocialMediaInformationEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdSocialMediaInformationEntity() {
		super();
    }
