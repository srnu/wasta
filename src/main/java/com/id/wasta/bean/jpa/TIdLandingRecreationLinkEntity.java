...
/**
 * Persistent class for entity stored in table "t_id_landing_recreation_link"
 *
...
@Entity
@Table(name="t_id_landing_recreation_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingRecreationLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingRecreationLinkEntity x" )
} )
public class TIdLandingRecreationLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingRecreationLinkEntity() {
		super();
    }
