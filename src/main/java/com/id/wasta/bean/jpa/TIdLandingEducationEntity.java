...
/**
 * Persistent class for entity stored in table "t_id_landing_education"
 *
...
@Entity
@Table(name="t_id_landing_education")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingEducationEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingEducationEntity x" )
} )
public class TIdLandingEducationEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingEducationEntity() {
		super();
    }
