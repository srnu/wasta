...
/**
 * Persistent class for entity stored in table "t_id_landing_personal_priorities_link"
 *
...
@Entity
@Table(name="t_id_landing_personal_priorities_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingPersonalPrioritiesLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingPersonalPrioritiesLinkEntity x" )
} )
public class TIdLandingPersonalPrioritiesLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingPersonalPrioritiesLinkEntity() {
		super();
    }
