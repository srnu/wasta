...
/**
 * Persistent class for entity stored in table "t_id_personal_interests_access"
 *
...
@Entity
@Table(name="t_id_personal_interests_access")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdPersonalInterestsAccessEntity.countAll", query="SELECT COUNT(x) FROM TIdPersonalInterestsAccessEntity x" )
} )
public class TIdPersonalInterestsAccessEntity implements Serializable {
    ...
    @Column(name="pia_peri_key", nullable=false)
    private Long piaPeriKey;
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdPersonalInterestsAccessEntity() {
		super();
    }
    ...
    public Long getPiaPeriKey() {
		return piaPeriKey;
	}
	public void setPiaPeriKey(Long piaPeriKey) {
		this.piaPeriKey = piaPeriKey;
	}
