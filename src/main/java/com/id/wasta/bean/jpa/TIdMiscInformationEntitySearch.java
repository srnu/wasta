...
/*
 * Created on 8 Dec 2016 ( Time 10:37:14 )
...
@NamedQueries ( {
  @NamedQuery ( name="TIdMiscInformationEntitySearch.countAll", query="SELECT COUNT(x) FROM TIdMiscInformationEntitySearch x" )
} )
public class TIdMiscInformationEntitySearch implements Serializable {
    ...
    //----------------------------------------------------------------------
    @ManyToOne
    @JoinColumn(name="pimi_pin_key", referencedColumnName="pin_key")
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdMiscInformationEntitySearch() {
		super();
    }
