...
/**
 * Persistent class for entity stored in table "t_id_landing_professional_expertise_link"
 *
...
@Entity
@Table(name="t_id_landing_professional_expertise_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingProfessionalExpertiseLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingProfessionalExpertiseLinkEntity x" )
} )
public class TIdLandingProfessionalExpertiseLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingProfessionalExpertiseLinkEntity() {
		super();
    }
