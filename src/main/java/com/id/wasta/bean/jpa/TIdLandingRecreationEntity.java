...
/**
 * Persistent class for entity stored in table "t_id_landing_recreation"
 *
...
@Entity
@Table(name="t_id_landing_recreation")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingRecreationEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingRecreationEntity x" )
} )
public class TIdLandingRecreationEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingRecreationEntity() {
		super();
    }
