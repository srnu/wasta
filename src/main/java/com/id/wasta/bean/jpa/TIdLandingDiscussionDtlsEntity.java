...
/**
 * Persistent class for entity stored in table "t_id_landing_discussion_dtls"
 *
...
@Entity
@Table(name="t_id_landing_discussion_dtls")
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingDiscussionDtlsEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingDiscussionDtlsEntity x" )
} )
public class TIdLandingDiscussionDtlsEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingDiscussionDtlsEntity() {
		super();
    }
