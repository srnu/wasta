...
/**
 * Persistent class for entity stored in table "t_id_landing_education_link"
 *
...
@Entity
@Table(name="t_id_landing_education_link" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="TIdLandingEducationLinkEntity.countAll", query="SELECT COUNT(x) FROM TIdLandingEducationLinkEntity x" )
} )
public class TIdLandingEducationLinkEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public TIdLandingEducationLinkEntity() {
		super();
    }
